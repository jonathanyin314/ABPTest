...
function showResult() {
    ...
    const getMajor = (arr) => {
        const c = arr.reduce((acc, v) => { acc[v] = (acc[v] || 0) + 1; return acc; }, {});
    ...
    document.getElementById('character-desc').innerText = `[核心体态: ${d.vibe}] 遵循极简素体设计，去道具化，演绎家族原型气质。`;
